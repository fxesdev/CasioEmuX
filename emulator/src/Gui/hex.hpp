// Modified version of https://github.com/ocornut/imgui_club/blob/63c7fed4b31c50c8a529b6c15ae7d7d9e89812a6/imgui_memory_editor/imgui_memory_editor.h
...
//   mem_edit_1.DrawWindow(me_mmu, "Memory Editor", data, data_size);
//
// Usage:
//   // If you already have a window, use DrawContents() instead:
//   static MemoryEditor mem_edit_2;
//   ImGui::Begin("MyWindow")
//   mem_edit_2.DrawContents(me_mmu, this, sizeof(*this), (size_t)this);
//   ImGui::End();
//
// Changelog:
                ...
                for (int n = 0; n < Cols && addr < mem_size; n++, addr++)
                {
                    ...
                    if (DataEditingAddr == addr)
                    {
                        ...
                        if (DataEditingTakeFocus)
                        {
                            ...
                            ImSnprintf(DataInputBuf, 32, format_byte, ReadFn ? ReadFn(mem_data, addr) : (ImU8)mmu->ReadData(base_display_addr + addr, false));
                        }
                        struct UserData
                        {
                        ...
                        ImSnprintf(user_data.CurrentBufOverwrite, 3, format_byte, ReadFn ? ReadFn(mem_data, addr) : (ImU8)mmu->ReadData(base_display_addr + addr, false));
