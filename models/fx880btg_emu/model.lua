do
	...
	generate( 30, 384, 32, 32, 5, 4, 48, 40, {
		...
		0x64, '0', 0x63, '.', 0x62, 'E', 0x61, 'F' , 0x60, 'Return',
	})
	generate( 32, 316, 25, 25, 6, 2, 39, 34, {
		0x04, 'X', 0x14, 'N', 0x24, 'R', 0x34, '', 0x44, '', 0x54, '',
		0x03, '', 0x13, '', 0x23, '', 0x33, '', 0x43, '', 0x53, '',
	})
	generate( 32, 240, 25, 25, 6, 1, 39, 0, {
		0x06, 'F5', 0x16, 'B', 0x26, 'Left', 0x36, 'O', 0x46, 'Right', 0x56, 'PageDown',
	})
	generate( 32, 280, 25, 25, 3, 1,  40,  0, {0x05, 'F1', 0x15, 'V', 0x25, 'Z',})
	generate(188, 280, 25, 25, 2, 1,  40,  0, {0x45, 'C', 0x55, 'T',})
	generate( 150, 275, 24, 24, 1, 1,  0,  0, {0x35, 'Down',})
	generate(71, 205, 25, 25, 3, 1,  78,  0, {0x17, 'F3', 0x37, 'Up', 0x57, 'PageUp',})
	generate(34, 204, 22, 22, 1, 1, 0, 0, {0xFF, 'F4'})
end
