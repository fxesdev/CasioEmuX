do
	...
	generate(49, 524, 58, 41, 5, 4, 64, 53, {
	...
	generate(50, 388, 45, 29, 6, 3, 53, 44, {
		0x05, '', 0x15, '', 0x25, '', 0x35, '', 0x45, '', 0x55, '',
		0x04, '', 0x14, '', 0x24, '', 0x34, '', 0x44, '', 0x54, '',
		0x03, '', 0x13, '', 0x23, '', 0x33, '', 0x43, '', 0x53, '',
	})
	generate( 50, 345, 45, 29, 2, 1,  53,  0, {0x06, 'F5', 0x16, 'F6',})
	generate(262, 345, 45, 29, 2, 1,  53,  0, {0x46, 'F7', 0x56, 'F8',})
	generate( 53, 283, 37, 34, 2, 1, 50,  0, {0x07, 'F1', 0x17, 'F2',})
	generate(271, 283, 37, 34, 2, 1, 50,  0, {0x47, 'F3', 0xFF, 'F4',})
	generate(155, 319, 33, 32, 2, 1,  67,  0, {0x26, 'Left', 0x37, 'Right',})
	generate(188, 289, 34, 30, 1, 2,   0, 62, {0x27, 'Up', 0x36, 'Down',})

	emu:model({
		model_name = "fx-570VN PLUS 2nd edition",
